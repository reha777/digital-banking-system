...
public class LoanRepaymentTests
{
    ...
    private sealed class Fixture : IAsyncDisposable
    {
        ...
        public static async Task<Fixture> CreateAsync(int termMonths = 6)
        {
            ...
            var destination = new Account { Id = Guid.NewGuid(), UserId = owner.Id, AccountNumber = "BA0000001000", Currency = "BAM", Balance = 0, AccountTypeId = BankingApp.Domain.Constants.AccountTypeCodes.CheckingId, CreatedAtUtc = now };
            var source = new Account { Id = Guid.NewGuid(), UserId = owner.Id, AccountNumber = "BA0000002000", Currency = "BAM", Balance = 10000, AccountTypeId = BankingApp.Domain.Constants.AccountTypeCodes.SavingsId, CreatedAtUtc = now };
            var other = new Account { Id = Guid.NewGuid(), UserId = owner.Id, AccountNumber = "BA0000003000", Currency = "BAM", Balance = 10000, AccountTypeId = BankingApp.Domain.Constants.AccountTypeCodes.CheckingId, CreatedAtUtc = now };
