...
class BankCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final groupedNumber = revealed
        ? _formatCardNumber(sensitiveCardNumber ?? card?.cardNumber ?? '')
        : _maskedCardNumber(card);
...
String _maskedCardNumber(BankCardModel? card) {
  if (card == null) return '4562  ••••  ••••  0000';
  final value = card.maskedCardNumber;
