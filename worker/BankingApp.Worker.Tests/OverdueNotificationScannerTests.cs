...
public sealed class OverdueNotificationScannerTests
{
    ...
    public async Task Scan_notifies_only_overdue_pending_installment_and_deduplicates_multiple_runs()
    {
        ...
        var account = new Account { Id = Guid.NewGuid(), UserId = customer.Id, AccountNumber = "1000000001", AccountTypeId = AccountTypeCodes.CheckingId, Currency = "BAM", CreatedAtUtc = DateTime.UtcNow };
